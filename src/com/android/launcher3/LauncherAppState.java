...
public class LauncherAppState {
    ...
    private LauncherAppState(Context context) {
        ...
        setSearchAppAvailable(PixysUtils.isPackageInstalled(context, LauncherTab.SEARCH_PACKAGE));
        setCalendarAppAvailable(PixysUtils.isPackageInstalled(context, "com.google.android.calendar"));
